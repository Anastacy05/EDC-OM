...
// Code déjà mort avant cette date : ces deux fonctions lisaient `mockOMs` via
// `getParticipationsDeEmploye` (lib/mockData.ts, lui-même commenté ce jour) et
// n'étaient plus appelées par rien depuis l'étape 8 (23/08/2026) — la
// détection de conflit et la borne d'âge à la retraite vivent maintenant dans
// lib/data/om.ts, sur les vraies données, avec une correction au passage :
// l'âge y est apprécié à la date de RETOUR, pas de départ (cf. commentaire de
// lib/data/om.ts autour de `anneesRevolues`).
//
